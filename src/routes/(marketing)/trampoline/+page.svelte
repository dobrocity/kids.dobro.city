...
{#if isClient}
  <div class="flex justify-center md:mt-2 mb-2 p-4">
    <model-viewer
      src="/models/trampoline.glb"
      ios-src="/models/trampoline.usdz"
      alt="3D Trampoline Model"
      ar
...
>
  ...
  >
    <div class="px-6">
      <h1 class="text-2xl lg:text-4xl font-bold mb-4">Apply to develop</h1>
      <p class="text-lg">Digital twin of a inground trampoline with:</p>
      <ul class="list-disc list-outside pl-6 py-4 space-y-1">
        <li class="">Your vision</li>
        <li class="">Your potential</li>
        <li class="">Your skills</li>
        <li class="">
          Under <a
            href="https://creativecommons.org/licenses/by-sa/4.0/"
            class="link">CC BY-SA 4.0</a
          >
        </li>
      </ul>
