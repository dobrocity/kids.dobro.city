...
<div class="flex justify-center md:mt-2 mb-2 p-4">
  <iframe
    title="Climning wall"
    src="https://3dwarehouse.sketchup.com/embed/ecd1ebba-8777-4b38-b61b-eddf6fbaac00?token=2O5AoFzBhM0=&binaryName=s21"
    frameborder="0"
    scrolling="no"
    marginheight="0"
    marginwidth="0"
...
>
  ...
  >
    <div class="px-6">
      ...
      <p class="text-lg">Our innovative climbing panel for kids offers:</p>
      <ul class="list-disc list-outside pl-6 py-4 space-y-1">
        <li class="">Safe and engaging climbing experience</li>
        <li class="">Developmental benefits for motor skills</li>
        <li class="">Customizable difficulty levels</li>
        <li class="">Colorful, attractive design that kids love</li>
      </ul>
      <p>Interested in this project? Complete the form to get involved! *</p>
      <p class="text-sm pt-8">
        *We will respond to your inquiry as soon as possible. Let's build
        something amazing for kids!
      </p>
    </div>
  </div>
